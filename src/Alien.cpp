 ...
 */
Alien::Alien(float startX, float startY) : x(startX), y(startY) {}
 ...
 */
void Alien::draw(float offsetX, float offsetY) {
    float size = 0.012f;  // Tamanho de cada "pixel" do sprite
